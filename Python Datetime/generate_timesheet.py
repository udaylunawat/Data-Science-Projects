...
def main():
    ...
    for index, twm in week_data.iterrows():
        ...
        if hours > discount_threshold:
            ...
            print(f"Total time below {discount_threshold} hrs, hence billing at ${base_rate}/hr.\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--discounted_rate', help='discounted rate', required=False, default=25)
    parser.add_argument('-t', '--threshold', help='discount threshold', required=False, default=14)
